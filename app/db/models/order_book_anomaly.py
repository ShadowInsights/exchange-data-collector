...
class OrderBookAnomalyModel(BaseModel):
    ...
    price: Mapped[Decimal] = mapped_column(pg_Decimal, nullable=False)
    quantity: Mapped[Decimal] = mapped_column(pg_Decimal, nullable=False)
    order_liquidity: Mapped[Decimal] = mapped_column(
        pg_Decimal, nullable=False
    )
    average_liquidity: Mapped[Decimal] = mapped_column(
        pg_Decimal, nullable=False
    )
